...
export default React.forwardRef(function LetterExplain({ nextFunc, audioList, _geo, _baseGeo }, ref) {
    ...
    const objectPosList =
        [
            {
                ani: 1, w: 0.28, l: 1, b: 0.25, p: 'duck1'
            },
            {
                ani: 1, w: 0.29, l: 1.2, b: 0.15, p: 'duck2'
            },
        ]
    useEffect(
        () => {
            ...
            audioList.bodyAudio2.src = prePathUrl() + "sounds/origin/EP_02_Audio_39.mp3"   //exlain voice    
