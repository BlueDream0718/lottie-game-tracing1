...
export default React.forwardRef(function LetterExplain({ nextFunc, audioList, _geo, _baseGeo }, ref) {
    ...
    useEffect(
        () => {
            ...
            audioList.bodyAudio2.src = prePathUrl() + "sounds/origin/EP_02_Audio_57.mp3"   //exlain voice  
    ...
    function zoomFunc() {
        moveFunc(backgroundRef, durationList[2], 'scale(0.4) translate(-25%,-25%)')
