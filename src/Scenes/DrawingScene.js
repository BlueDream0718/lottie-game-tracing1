    ...
    const clickUpperCase = () => {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                highlightRefList[0].current.setClass('appear')
                            ...
                            if (isPassable) {
                                ...
                                if (compDistance < 40 && currentMinDisIndex == currentPath.length - 1) {
                                    ...
                                    if (stepCount == currentMovePath[letterNum].length - 1) {
                                        ...
                                        if (currentLetterPosList[letterNum].lastPosList && currentLetterPosList[letterNum].lastPosList.length > highCurrentNum) {
                                            let lastPos = currentLetterPosList[letterNum].lastPosList[highCurrentNum]
        ...
        >
            ...
            <div
                ...
                <BaseImage
                    ...
                    url={"prop/" + IconPrefix + textInfoList[letterNum][currentImgNumOriginal].text + ".svg"}
                ...
                <span
...

                    {
                        !textInfoList[letterNum][currentImgNumOriginal].isLast
                            ? <span style={{ color: 'red' }}>{textInfoList[letterNum][currentImgNumOriginal].text[0]}
                                <span style={{ color: 'black' }}>{textInfoList[letterNum][currentImgNumOriginal].text.slice(1)}</span>
                            </span>
                            : <span style={{ color: 'black' }}>{textInfoList[letterNum][currentImgNumOriginal].text.slice(0, textInfoList[letterNum][currentImgNumOriginal].text.length - 1)}
                                <span style={{ color: 'red' }}>{textInfoList[letterNum][currentImgNumOriginal].text.slice(-1)}</span>
                            </span>
                    }
