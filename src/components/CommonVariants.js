...
const wordVoiceList = [
    ...
    ['34', '36', '33'],
    ['42', '39', '18_A'], //f 
    ['19_A', '45', '48'], //g 3-2 ,1-3
    ['51', '52', '20_A'], //h 3-1, 1-2
    ['60', '21A', '57'],  //i
    ['21A', '21C', '66'],  //j  3-1
    ['70', '23_A', '72'],  //k 3-1, 1-3
    ['78', '75', '24A'], //l
    ['25A', '81', '25C'], //m 1-2
    ['87', '26A', '90'], //n
    ['96', '27A', '93'], //o //2-3
    ['98', '102', '28A'], //p
    ['105', '108', '106'], //q 3-2,2-3
    ['111', '29_A', '29C'], //r
    ['117', '118', '120'], //s 2-3,3-2
    ['30A', '30C', '123'], //t 1-3
    ['129', '31A', '31C'], //u
    ['136', '32A', '32C'], //v 2-1
    ['142', '141', '33A'], //w 3-2
    ['148', '150', '34A'], //x  2-1,3-2
    ['153', '154', '156'], //y 3-2, 2-3
    ['159', '162', '160'], //
]
...
export const lowerFirstPosList = [
    ...
    [
        { x: 715, y: 158 },
        { x: 715, y: 420, letter_start: true },
        { x: 714, y: 418, letter_start: true },
    ],
    //E
    [
        { x: 552, y: 374 },
        { x: 714, y: 406, letter_start: true },
    ...
    [
        { x: 474, y: 254 },
        { x: 474, y: 508, letter_start: true },
        { x: 623, y: 507, letter_start: true },

    ],
    //N
    [
        { x: 532, y: 213 },
        { x: 532, y: 544, letter_start: true },
    ],
    //O
    [
        { x: 630, y: 268, firstObj: 2 },

    ],
    //P
    [
        { x: 547, y: 154 },
        { x: 547, y: 588, letter_start: true },
        { x: 559, y: 234, letter_start: true },
    ],
    //q
    [
        { x: 642, y: 223, firstObj: 3, lastObj: 2 },
        { x: 624, y: 370, letter_start: true },
        { x: 686, y: 301, letter_start: true },
        { x: 666, y: 535, letter_start: true },
    ],
    //R
    [
        { x: 575, y: 195 },
        { x: 575, y: 491, letter_start: true },
    ],
    //S
    [
        { x: 762, y: 304 },
        { x: 735, y: 385, letter_start: true },
    ],
    //T
    [
        { x: 628, y: 159 },
    ...
    [
        { x: 522, y: 206 },
        { x: 601, y: 499, letter_start: true },

    ],
    //W
    [
        { x: 450, y: 232 },
        { x: 526, y: 505, letter_start: true },
        { x: 604, y: 236, letter_start: true },
        { x: 685, y: 502, letter_start: true },
    ],
    //X
    [
        { x: 518, y: 217 },
        { x: 729, y: 220, letter_start: true },
    ],
    //Y
    [
        { x: 512, y: 194, lastObj: 3 },
        { x: 733, y: 188, letter_start: true },
    ],
    //Z
    [
        { x: 501, y: 252 },
        { x: 721, y: 229, letter_start: true },
        { x: 483, y: 440, letter_start: true },
    ],
]
...
const animtionList = [
    ...
    { scale: 0.16, left: 0.415, top: 0.235 },
    { scale: 0.085, left: 0.455, top: 0.24 },
    { scale: 0.13, left: 0.395, top: 0.24 },
    { scale: 0.16, left: 0.42, top: 0.25 }, //K
    { scale: 0.06, left: 0.435, top: 0.24 },
    { scale: 0.3, left: 0.335, top: 0.355 },
    { scale: 0.24, left: 0.375, top: 0.295 },
    { scale: 0.22, left: 0.38, top: 0.3 },
    { scale: 0.19, left: 0.395, top: 0.215 },  //L
    { scale: 0.23, left: 0.395, top: 0.235 },
    { scale: 0.23, left: 0.4, top: 0.255 },
    { scale: 0.22, left: 0.4, top: 0.25 },
    { scale: 0.17, left: 0.425, top: 0.21 },
    { scale: 0.22, left: 0.375, top: 0.27 },
    { scale: 0.2, left: 0.395, top: 0.27 },
    { scale: 0.34, left: 0.31, top: 0.3 },  //W
    { scale: 0.2, left: 0.385, top: 0.265 },
    { scale: 0.2, left: 0.39, top: 0.235 },
    { scale: 0.22, left: 0.375, top: 0.275 },
]
